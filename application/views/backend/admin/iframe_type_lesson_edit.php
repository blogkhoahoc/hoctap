...
<div class="form-group">
    ...
    <input type="text" class="form-control" name="duration" id="duration" placeholder="00:00:00" value="<?php echo empty($lesson_details['duration']) ? '00:00:00' : $lesson_details['duration']; ?>">
