...
<div class="row justify-content-center">
    <div class="col-xl-12 mb-4 text-center mt-3">
		...
		<a href="javascript:void(0)" class="btn btn-outline-primary btn-rounded btn-sm ml-1" onclick="showAjaxModal('<?php echo site_url('modal/popup/lesson_import_csv/'.$course_id); ?>', 'Nhập bài học từ CSV')"><i class="mdi mdi-file-delimited"></i> Nhập CSV</a>
