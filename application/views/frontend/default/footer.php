<footer class="footer-area d-print-none mt-5 pt-5">
  <div class="container-xl py-4">
    <div class="row mb-3">
      ...
      <div class="col-6 col-sm-6 col-xl-2 px-4">
        <h6 class="text-white fw-700 mb-4">
          <span class="header-underline"><?php echo site_phrase('help'); ?></span>
        </h6>
        <ul class="list-unstyled text-small">
          <li class="mb-2 mt-1"><a class="link-secondary footer-hover-link" href="<?php echo site_url('home/about_us'); ?>"><?php echo site_phrase('about_us'); ?></a></li>
          <li class="mb-2 mt-1"><a class="link-secondary footer-hover-link" href="<?php echo site_url('home/privacy_policy'); ?>"><?php echo site_phrase('privacy_policy'); ?></a></li>
          <li class="mb-2 mt-1"><a class="link-secondary footer-hover-link" href="<?php echo site_url('home/terms_and_condition'); ?>"><?php echo site_phrase('terms_and_condition'); ?></a></li>
          <li class="mb-2 mt-1"><a class="link-secondary footer-hover-link" href="<?php echo site_url('home/refund_policy'); ?>"><?php echo site_phrase('refund_policy'); ?></a></li>
        </ul>
      </div>
