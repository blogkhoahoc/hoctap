    ...
    <?php else: ?>
        <div class="">
            ...
            if($lesson_details['lesson_type'] == 'video' || $lesson_details['lesson_type'] == '' || $lesson_details['lesson_type'] == NULL):
                ...
                <?php elseif (strtolower($provider) == 'academy_cloud'):?>
                    <?php $video_url = $this->academy_cloud_model->get_cloud_video_url($lesson_details['cloud_video_id']) ?>
                    <link rel="stylesheet" href="<?php echo base_url();?>assets/global/plyr/plyr.css">
                    <video poster="<?php echo $lesson_thumbnail_url;?>" id="player" playsinline controls>
                        ...
                        <?php if ($lesson_details['caption'] != "" && file_exists('uploads/lesson_files/captions/'.$lesson_details['caption'])): ?>
                            <track kind="captions" label="Caption" src="<?php echo base_url('uploads/lesson_files/captions/'.$lesson_details['caption']); ?>" srclang="en" default />
                        <?php endif; ?>
                    </video>
                    ...
                    <div class="mt-5">
                          <?php
                            ...
                            <video id="player" playsinline controls>
                               <source class="remove_video_src" src="https://drive.google.com/uc?export=download&id=<?php echo $video_id; ?>" type='video/mp4'>
